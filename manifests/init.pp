...
class htcondor (
  ...
  $cgroup_memory_policy           = $htcondor::params::cgroup_memory_policy,
  $cgroup_custom_policy_expr      = $htcondor::params::cgroup_custom_policy_expr,
  $cgroup_low_memory_limit        = $htcondor::params::cgroup_low_memory_limit,
  $cgroup_ignore_cache_mem        = $htcondor::params::cgroup_ignore_cache_mem,
  $cgroup_polling_interval        = $htcondor::params::cgroup_polling_interval,
  $startd_rank_expression         = $htcondor::params::startd_rank_expression,
